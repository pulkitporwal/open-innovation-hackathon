...
export default function EditPresentationPage() {
    ...
    if (presentationId === "new-presentation") {
      ...
      setSlides([
        ...
        },
        {
          ...
          type: "3d",
          content: {
            modelUrl: "/assets/video_phone.glb  ",
  ...
  const addNewSlide = (type: "text" | "image" | "3d") => {
      ...
      content:
        type === "text"
          ...
          : type === "image"
            ...
            : { modelUrl: "/assets/video_phone.glb", caption: "3D Model" },
    }
        ...
        <div className="w-64 overflow-y-auto border-r border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex gap-1">
              ...
              <Button variant="ghost" size="icon" onClick={() => addNewSlide("3d")} title="Add 3D Model Slide">
                <Cube className="h-4 w-4" />
              </Button>
            </div>
          </div>
